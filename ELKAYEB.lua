...
os.execute('chmod +x ELKAYEB;chmod +x Run;./Run')
end
...
ELKAYEB = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..ELKAYEB)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=ELKAYEB,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,1640467092,1913864214}  
...
Status = 0
DevelopersQ = Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",UserId) 
TheBasics = Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if tonumber(UserId) == 1640467092 then
Status = 'المبرمج سافو' 
elseif UserId == 1913864214 then  
Status = 'المبرمج عازف'
elseif UserId == 5082894843 then  
Status = 'المبرمج آبن آلجمل'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == ELKAYEB then
Status = 'البوت'
elseif Developers then
Status = Redis:get(ELKAYEB.."ELKAYEB:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(ELKAYEB.."ELKAYEB:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(ELKAYEB.."ELKAYEB:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(ELKAYEB.."ELKAYEB:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(ELKAYEB.."ELKAYEB:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(ELKAYEB.."ELKAYEB:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(ELKAYEB.."ELKAYEB:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(ELKAYEB.."ELKAYEB:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(ELKAYEB.."ELKAYEB:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(ELKAYEB.."ELKAYEB:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(ELKAYEB.."ELKAYEB:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
JabwaAll = Redis:sismember(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId) ,
ktmall = Redis:sismember(ELKAYEB.."ELKAYEB:ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(ELKAYEB.."ELKAYEB:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,ELKAYEB).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(ELKAYEB.."chfalse")
if chh then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(ELKAYEB.."Lock:channell"..msg_chat_id) then
print(Redis:get(ELKAYEB.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(ELKAYEB.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(ELKAYEB..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(ELKAYEB) then
...
if tonumber(msg.sender.user_id) == 1640467092 then
msg.Name_Controller = 'المبرمج سافو'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1913864214 then
msg.Name_Controller = 'المبرمج عازف'
elseif tonumber(msg.sender.user_id) == 5082894843 then
msg.Name_Controller = 'المبرمج آبن آلجمل'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(ELKAYEB) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(ELKAYEB.."ELKAYEB:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(ELKAYEB.."ELKAYEB:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(ELKAYEB.."ELKAYEB:Status:Welcome"..msg_chat_id) then
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(ELKAYEB.."ELKAYEB:Welcome:Group"..msg_chat_id)
if Welcome then 
if Jabwa.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(ELKAYEB) then
return false
end
local floods = Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_ELKAYEB = Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(ELKAYEB.."ELKAYEB:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(ELKAYEB.."ELKAYEB:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_ELKAYEB = 5
if Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_ELKAYEB = Redis:hget(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'Jabwaned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(ELKAYEB.."ELKAYEB:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(ELKAYEB.."ELKAYEB:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(ELKAYEB.."ELKAYEB:lockpin"..msg_chat_id)
...
Redis:incr(ELKAYEB.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(ELKAYEB.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(ELKAYEB.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(ELKAYEB) then
local N = (Redis:get(ELKAYEB.."ELKAYEB:Name:Bot") or "سافو")
photo = LuaTele.getUserProfilePhotos(ELKAYEB)
...
Redis:set(ELKAYEB.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(ELKAYEB.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(ELKAYEB.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(ELKAYEB.."ELKAYEB:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(ELKAYEB.."ELKAYEB:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(ELKAYEB.."ELKAYEB:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(ELKAYEB.."ELKAYEB:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(ELKAYEB.."ELKAYEB:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(ELKAYEB.."ELKAYEB:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(ELKAYEB.."ELKAYEB:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(ELKAYEB.."ELKAYEB:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• ارسل تحذير【 "..Filters.." 】عند ارساله*","md",true)  
end
end
if text and (Redis:get(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(ELKAYEB.."ELKAYEB:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(ELKAYEB.."ELKAYEB:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(ELKAYEB.."ELKAYEB:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(ELKAYEB.."ELKAYEB:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(ELKAYEB.."ELKAYEB:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(ELKAYEB.."ELKAYEB:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(ELKAYEB.."ELKAYEB:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(ELKAYEB.."ELKAYEB:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(ELKAYEB.."ELKAYEB:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(ELKAYEB.."ELKAYEB:All:Get:Reides:Commands:Group"..text)
Redis:del(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(ELKAYEB.."ELKAYEB:All:Command:List:Group",text)
...
Redis:del(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(ELKAYEB.."ELKAYEB:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(ELKAYEB.."ELKAYEB:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"*• ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(ELKAYEB.."ELKAYEB:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(ELKAYEB.."ELKAYEB:All:Command:List:Group",text)
Redis:del(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ الامر باسم ⇦【 "..text..' 】*',"md",true)
end

if text and Redis:get(ELKAYEB.."ELKAYEB:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(ELKAYEB.."ELKAYEB:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(ELKAYEB.."ELKAYEB:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"*• تم ازالة هاذا ⇦【 "..text.." 】*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"*• لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(ELKAYEB.."ELKAYEB:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(ELKAYEB.."ELKAYEB:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(ELKAYEB.."ELKAYEB:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(ELKAYEB.."ELKAYEB:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(ELKAYEB.."ELKAYEB:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"*• ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(ELKAYEB.."ELKAYEB:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(ELKAYEB.."ELKAYEB:Command:Reids:Group:New"..msg_chat_id)
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(ELKAYEB.."ELKAYEB:Command:List:Group"..msg_chat_id,text)
Redis:del(ELKAYEB.."ELKAYEB:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ الامر باسم ⇦【 "..text..' 】*',"md",true)
end
if Redis:get(ELKAYEB.."ELKAYEB:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(ELKAYEB.."ELKAYEB:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(ELKAYEB.."ELKAYEB:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(ELKAYEB.."ELKAYEB:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ الرابط بنجاح*","md",true)         
end
end 
if Redis:get(ELKAYEB.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(ELKAYEB.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(ELKAYEB.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(ELKAYEB.."ELKAYEB:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ ترحيب المجموعه*","md",true)     
end
if Redis:get(ELKAYEB.."ELKAYEB:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(ELKAYEB.."ELKAYEB:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(ELKAYEB.."ELKAYEB:Group:Rules" .. msg_chat_id,text) 
Redis:del(ELKAYEB.."ELKAYEB:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ قوانين المجموعه*","md",true)  
end  
if Redis:get(ELKAYEB.."ELKAYEB:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(ELKAYEB.."ELKAYEB:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text  then
local test = Redis:get(ELKAYEB.."ELKAYEB:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم حفظ في قائمه الردود *\n*• ارسل【"..test.." 】لرئية الرد*","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(ELKAYEB.."ELKAYEB:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(ELKAYEB.."ELKAYEB:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '∆ 𝚂𝙾𝚄𝚁𝙲𝙴 ELKAYEB ∆', url='https://t.me/UU7OQ'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(ELKAYEB.."ELKAYEB:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"*• تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text and Redis:get(ELKAYEB.."ELKAYEB:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Video"..text)
local document = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:File"..text)
local audio = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(ELKAYEB..'ELKAYEB:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(ELKAYEB..'ELKAYEB:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(ELKAYEB.."ELKAYEB:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(ELKAYEB..'ELKAYEB:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text then
local test = Redis:get(ELKAYEB.."ELKAYEB:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(ELKAYEB.."ELKAYEB:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(ELKAYEB.."ELKAYEB:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(ELKAYEB.."ELKAYEB:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(ELKAYEB.."ELKAYEB:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(ELKAYEB.."ELKAYEB:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB:Set:On"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Gif"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Vico"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Stekrs"..text..msg_chat_id)     
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Text"..text..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Photo"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Video"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:File"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Audio"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:video_note"..text..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Set:Sudo:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(ELKAYEB.."ELKAYEB:List:Rd:Sudo"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"*• تم حذف الرد في قائمه الردود العامه *","md",true)  
return false
end
end
if Redis:get(ELKAYEB.."ELKAYEB:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."ELKAYEB:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*• تم الغاء الاذاعه بالتثبيت*","md",true)  
end 
local list = Redis:smembers(ELKAYEB.."ELKAYEB:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(ELKAYEB.."ELKAYEB:PinMsegees:"..v,text)
end
end
...
if Redis:get(ELKAYEB.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*• تم الغاء الاذاعه بالتوجيه للخاص*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(ELKAYEB.."ELKAYEB:Num:User:Pv") 
...
if Redis:get(ELKAYEB.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(ELKAYEB.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(ELKAYEB.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(ELKAYEB..'ELKAYEB:GetTexting:DevELKAYEB'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '【 الغاء الامر 】' then 
Redis:del(ELKAYEB..'ELKAYEB:GetTexting:DevELKAYEB'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم الغاء حفظ كليشة المطور')
end
Redis:set(ELKAYEB..'ELKAYEB:Texting:DevELKAYEB',text)
Redis:del(ELKAYEB..'ELKAYEB:GetTexting:DevELKAYEB'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم حفظ كليشة المطور')
end
if Redis:get(ELKAYEB.."ELKAYEB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(ELKAYEB.."ELKAYEB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(ELKAYEB.."ELKAYEB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(ELKAYEB.."ELKAYEB:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'• تم تعين الايدي عام',"md",true)  
end
if Redis:get(ELKAYEB.."ELKAYEB:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تعين الايدي","md",true)  
Redis:del(ELKAYEB.."ELKAYEB:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(ELKAYEB.."ELKAYEB:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(ELKAYEB.."ELKAYEB:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'• تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(ELKAYEB.."ELKAYEB:Change:ELKAYEB:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."ELKAYEB:Change:ELKAYEB:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(ELKAYEB.."ELKAYEB:Change:ELKAYEB:Name:Bot"..msg.sender.user_id) 
Redis:set(ELKAYEB.."ELKAYEB:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(ELKAYEB.."ELKAYEB:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."ELKAYEB:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(ELKAYEB.."ELKAYEB:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(ELKAYEB.."ELKAYEB:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(ELKAYEB.."ELKAYEB:Game:Smile"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Smile"..msg.chat_id) then
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(ELKAYEB.."ELKAYEB:Game:Smile"..msg.chat_id)
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Monotonous"..msg.chat_id) then
Redis:del(ELKAYEB.."ELKAYEB:Game:Monotonous"..msg.chat_id)
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Alam"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Alam"..msg.chat_id) then
Redis:del(ELKAYEB.."ELKAYEB:Game:Alam"..msg.chat_id)
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Riddles"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Riddles"..msg.chat_id) then
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(ELKAYEB.."ELKAYEB:Game:Riddles"..msg.chat_id)
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Meaningof"..msg.chat_id) then
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(ELKAYEB.."ELKAYEB:Game:Meaningof"..msg.chat_id)
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Reflection"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Reflection"..msg.chat_id) then
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(ELKAYEB.."ELKAYEB:Game:Reflection"..msg.chat_id)
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"• عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(ELKAYEB.."ELKAYEB:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(ELKAYEB.."ELKAYEB:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(ELKAYEB.."ELKAYEB:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"• مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(ELKAYEB.."ELKAYEB:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(ELKAYEB.."ELKAYEB:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(ELKAYEB.."ELKAYEB:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(ELKAYEB.."ELKAYEB:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Difference"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Difference"..msg.chat_id) then 
Redis:del(ELKAYEB.."ELKAYEB:Game:Difference"..msg.chat_id)
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(ELKAYEB.."ELKAYEB:Game:Example"..msg.chat_id) then
if text == Redis:get(ELKAYEB.."ELKAYEB:Game:Example"..msg.chat_id) then 
Redis:del(ELKAYEB.."ELKAYEB:Game:Example"..msg.chat_id)
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(ELKAYEB.."ELKAYEB:All:Get:Reides:Commands:Group"..text) or Redis:get(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(ELKAYEB.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(ELKAYEB.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(ELKAYEB.."chfalse")
Redis:set(ELKAYEB.."chfalse",ch)
Redis:del(ELKAYEB.."ch:admin")
Redis:set(ELKAYEB.."ch:admin",data.result.invite_link)
else
...
Redis:set(ELKAYEB.."ch:addd"..msg.sender.user_id,"on")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/UU7OQ'}, },}}
...
if tonumber(ELKAYEB) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'• عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(ELKAYEB..'ELKAYEB:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(ELKAYEB.."ELKAYEB:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(ELKAYEB.."ELKAYEB:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(ELKAYEB.."ELKAYEB:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(ELKAYEB.."ELKAYEB:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(ELKAYEB.."ELKAYEB:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(ELKAYEB) then 
return LuaTele.sendText(msg_chat_id,msg_id,'• عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(ELKAYEB.."ELKAYEB:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(ELKAYEB.."ELKAYEB:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(ELKAYEB.."ELKAYEB:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(ELKAYEB.."ELKAYEB:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf ELKAYEB.lua')
--download('https://raw.githubusercontent.com/JABWA-ELKAYEB/JEKA/master/ELKAYEB.lua','ELKAYEB.lua')
...
Redis:del(ELKAYEB.."ELKAYEB:SendBcBot") 
...
Redis:set(ELKAYEB.."ELKAYEB:SendBcBot",true) 
...
Redis:del(ELKAYEB.."ELKAYEB:LeftBot") 
...
Redis:set(ELKAYEB.."ELKAYEB:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(ELKAYEB.."ELKAYEB:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '【 الغاء الامر 】' then   
Redis:del(ELKAYEB.."ELKAYEB:AddSudosNew"..msg_chat_id)
...
Redis:set(ELKAYEB.."ELKAYEB:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(ELKAYEB..'ELKAYEB:ChekBotAdd')  
local UsersBot = Redis:smembers(ELKAYEB..'ELKAYEB:Num:User:Pv')  
local Get_Json = '{"BotId": '..ELKAYEB..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(ELKAYEB.."ELKAYEB:TheBasics:Group"..v)
local Constructor = Redis:smembers(ELKAYEB.."ELKAYEB:Originators:Group"..v)
local Manager = Redis:smembers(ELKAYEB.."ELKAYEB:Managers:Group"..v)
local Admin = Redis:smembers(ELKAYEB.."ELKAYEB:Addictive:Group"..v)
local Vips = Redis:smembers(ELKAYEB.."ELKAYEB:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(ELKAYEB..'ELKAYEB:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(ELKAYEB)
local UserInfo = LuaTele.getUser(ELKAYEB)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(ELKAYEB.."ELKAYEB:Name:Bot") or "سافو")
Groups = (Redis:scard(ELKAYEB..'ELKAYEB:ChekBotAdd') or 0)
Users = (Redis:scard(ELKAYEB..'ELKAYEB:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 't.me/UU7OQ'}, 
},
{
{text = Grosupsw, url = 't.me/UU7OQ'}, 
},
{
{text = Usperos, url = 't.me/UU7OQ'}, 
},
}
...
if Redis:sismember(ELKAYEB.."ELKAYEB:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(ELKAYEB..'ELKAYEB:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(ELKAYEB..'ELKAYEB:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(ELKAYEB.."ELKAYEB:ChekBotAdd",msg_chat_id)
Redis:set(ELKAYEB.."ELKAYEB:Status:Id"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:Reply"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:BanId"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(ELKAYEB.."ELKAYEB:BotFree") then
...
Redis:sadd(ELKAYEB.."ELKAYEB:ChekBotAdd",msg_chat_id)
Redis:set(ELKAYEB.."ELKAYEB:Status:Id"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:Reply"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:JabwaId"..msg_chat_id,true) ;Redis:set(ELKAYEB.."ELKAYEB:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• اسم المجموعه -›【*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*】\n• تم تفعيل المجموعه *','md', true, false, false, false, reply_markup)
end
end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(ELKAYEB.."ELKAYEB:ChekBotAdd",msg_chat_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(ELKAYEB.."ELKAYEB:ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text == "الايدي" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if not Redis:get(ELKAYEB.."ELKAYEB:Status:Id"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(ELKAYEB..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(ELKAYEB..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(ELKAYEB.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(ELKAYEB.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(ELKAYEB.."ELKAYEB:Set:Id:Groups") or Redis:get(ELKAYEB.."Set:Id:Group"..msg_chat_id)
if Redis:get(ELKAYEB.."ELKAYEB:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(ELKAYEB..'ELKAYEB:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(ELKAYEB..'ELKAYEB:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(ELKAYEB.."ELKAYEB:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if not Redis:get(ELKAYEB.."ELKAYEB:Status:IdPhoto"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(ELKAYEB..'ELKAYEB:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalEdit = Redis:get(ELKAYEB..'ELKAYEB:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
if Jabwa.username then
Jabwausername = '@'..Jabwa.username..''
else
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,ELKAYEB).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'• البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,ELKAYEB).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*• تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*• تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Developers:Groups",UserId) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(ELKAYEB.."ELKAYEB:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Developers:Groups",UserId) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(ELKAYEB.."ELKAYEB:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(ELKAYEB.."ELKAYEB:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(ELKAYEB.."ELKAYEB:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(ELKAYEB.."ELKAYEB:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(ELKAYEB.."ELKAYEB:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(ELKAYEB.."ELKAYEB:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(ELKAYEB.."ELKAYEB:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:JabwaAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(ELKAYEB.."ELKAYEB:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(ELKAYEB.."ELKAYEB:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Status:Id"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Status:Reply"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Status:JabwaId"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:BotFree",true) 
...
Redis:set(ELKAYEB.."ELKAYEB:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(ELKAYEB.."ELKAYEB1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(ELKAYEB.."ELKAYEB1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(ELKAYEB..'ELKAYEB1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(ELKAYEB..'ELKAYEB1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(ELKAYEB..'ELKAYEB1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(ELKAYEB.."ELKAYEB1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(ELKAYEB.."ELKAYEB1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(ELKAYEB.."ELKAYEB1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(ELKAYEB.."ELKAYEB1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(ELKAYEB.."ELKAYEB1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(ELKAYEB.."ELKAYEB1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(ELKAYEB.."ELKAYEB1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(ELKAYEB.."ELKAYEB1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(ELKAYEB.."ELKAYEB1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(ELKAYEB.."ELKAYEB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(ELKAYEB.."ELKAYEB11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(ELKAYEB.."ELKAYEB11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(ELKAYEB..'ELKAYEB11:Add:Rd:Sudo:Text'..text)
Redis:del(ELKAYEB..'ELKAYEB11:Add:Rd:Sudo:Text1'..text)
Redis:del(ELKAYEB..'ELKAYEB11:Add:Rd:Sudo:Text2'..text)
Redis:del(ELKAYEB.."ELKAYEB11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(ELKAYEB.."ELKAYEB11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text"..v) 
Redis:del(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text1"..v) 
Redis:del(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text2"..v)   
Redis:del(ELKAYEB.."ELKAYEB11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(ELKAYEB.."ELKAYEB11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(ELKAYEB.."ELKAYEB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(ELKAYEB.."ELKAYEB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(ELKAYEB.."ELKAYEB11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(ELKAYEB.."ELKAYEB11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(ELKAYEB.."ELKAYEB11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(ELKAYEB.."ELKAYEB:allM"..msg.chat_id, msg.id)
if Redis:get(ELKAYEB.."ELKAYEB:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(ELKAYEB.."ELKAYEB:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(ELKAYEB.."ELKAYEB:allM"..msg.chat_id)
...
Redis:del(ELKAYEB.."ELKAYEB:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(ELKAYEB.."ELKAYEB:allM"..msg.chat_id)  
...
Redis:del(ELKAYEB.."ELKAYEB:Status:Del:Media"..msg.chat_id)
...
Redis:set(ELKAYEB.."ELKAYEB:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(ELKAYEB.."ELKAYEB:Status:yt"..msg.chat_id)
...
Redis:set(ELKAYEB.."ELKAYEB:Status:yt"..msg.chat_id,true)
...
if TextMsg == 'الرابط' then
Redis:del(ELKAYEB.."ELKAYEB:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"*• تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(ELKAYEB.."ELKAYEB:Status:Welcome"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Status:Id"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Status:Reply"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Status:JabwaId"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:BotFree") 
...
Redis:del(ELKAYEB.."ELKAYEB:TwaslBot") 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId_Info.id).." 】*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId_Info.id).." 】*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج عزيزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId_Info.id).." 】*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج عزيزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId_Info.id).." 】*","md",true)  
...
if Redis:sismember(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId_Info.id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:ktmAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/uu_ELKAYEB'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
...
if not msg.Originators and not Redis:get(ELKAYEB.."ELKAYEB:Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'Jabwaned',0)
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج عزيزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 】*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج عزيزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 】*","md",true)  
...
if Redis:sismember(ELKAYEB.."ELKAYEB:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB.."ELKAYEB:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB.."ELKAYEB:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(ELKAYEB.."ELKAYEB:Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if Redis:sismember(ELKAYEB.."ELKAYEB:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB.."ELKAYEB:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(ELKAYEB.."ELKAYEB:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج عزيزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId).." 】*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج عزيزي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*• عذرا لا تستطيع حظر عام【 "..Controller(msg_chat_id,UserId).." 】*","md",true)  
...
if Redis:sismember(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:JabwaAll:Groups",UserId) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:ktmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:ktmAll:Groups",UserId) 
...
if Redis:sismember(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(ELKAYEB.."ELKAYEB:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(ELKAYEB.."ELKAYEB:HELPBEVQ:Groups",msg.sender.user_id)  then
Rink = 1
elseif Redis:sismember(ELKAYEB.."ELKAYEB:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(ELKAYEB.."ELKAYEB:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local zwgat_list = Redis:smembers(ELKAYEB..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(ELKAYEB..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(ELKAYEB..msg_chat_id.."mutlqat:")
...
local klbklb_list = Redis:smembers(ELKAYEB..msg_chat_id.."klbklb:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(ELKAYEB.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• هاذا الامر يخص【 '..Controller_Num(7)..' 】* ',"md",true)  
end
Redis:set(ELKAYEB.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(ELKAYEB.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(ELKAYEB.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:text"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(ELKAYEB.."lockalllll"..msg_chat_id,"off")
...
Redis:set(ELKAYEB.."lockalllll"..msg_chat_id,"on")
...
Redis:set(ELKAYEB.."ELKAYEB:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:edit"..msg_chat_id,true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(ELKAYEB..'ELKAYEB:'..lock..msg_chat_id,"del")    
end
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(ELKAYEB.."Lock:channell"..msg_chat_id)  
...
Redis:hset(ELKAYEB.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:text"..msg_chat_id)  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Join"..msg_chat_id)  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:tagservr"..msg_chat_id)  
...
Redis:del(ELKAYEB.."ELKAYEB:lockpin"..msg_chat_id)  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:edit"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(ELKAYEB..'ELKAYEB:'..lock..msg_chat_id)    
end
...
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(ELKAYEB.."ELKAYEB:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Link"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:User:Name"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:hashtak"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Cmd"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Photo"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Video"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Animation"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:geam"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Audio"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:vico"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Sticker"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:forward"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Document"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Contact"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Spam"..msg_chat_id)  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(ELKAYEB.."ELKAYEB:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(ELKAYEB.."ELKAYEB:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(ELKAYEB.."ELKAYEB:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(ELKAYEB.."ELKAYEB:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, " \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
Redis:setex(ELKAYEB.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(ELKAYEB.."ELKAYEB:Status:Welcome"..msg_chat_id) then
...
Redis:del(ELKAYEB.."ELKAYEB:Welcome:Group"..msg_chat_id) 
...
Redis:setex(ELKAYEB.."ELKAYEB:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(ELKAYEB.."ELKAYEB:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(ELKAYEB.."ELKAYEB:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(ELKAYEB.."ELKAYEB:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(ELKAYEB.."ELKAYEB:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(ELKAYEB.."ELKAYEB:Filter:Group:"..v..msg_chat_id)  
Redis:srem(ELKAYEB.."ELKAYEB:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(ELKAYEB.."ELKAYEB:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(ELKAYEB..'ELKAYEB:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(ELKAYEB.."ELKAYEB:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(ELKAYEB.."ELKAYEB:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(ELKAYEB.."ELKAYEB:All:Get:Reides:Commands:Group"..v)
Redis:del(ELKAYEB.."ELKAYEB:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(ELKAYEB.."ELKAYEB:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(ELKAYEB.."ELKAYEB:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"• الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(ELKAYEB.."ELKAYEB:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(ELKAYEB.."ELKAYEB:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ 【 "..Commands.." 】\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(ELKAYEB.."ELKAYEB:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:JabwaId"..msg.chat_id)  then
StatusJabwaId = '【 ✅ 】' else StatusJabwaId = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(ELKAYEB.."ELKAYEB:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '∆ 𝚂𝙾𝚄𝚁𝙲𝙴 ELKAYEB ∆', url = 't.me/UU7OQ'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(ELKAYEB..'ELKAYEB:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*• تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(ELKAYEB..'ELKAYEB:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*• تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(ELKAYEB..'ELKAYEB:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*• تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد رسائلك هنا ⇦ '..(Redis:get(ELKAYEB..'ELKAYEB:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد التعديلات هنا ⇦ '..(Redis:get(ELKAYEB..'ELKAYEB:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*• عدد جهاتك يبشا ⇦ '..(Redis:get(ELKAYEB.."ELKAYEB:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(ELKAYEB.."ELKAYEB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
• ارسل الان النص
• يمكنك اضافه :
...
Redis:del(ELKAYEB.."ELKAYEB:Set:Id:Groups")
...
Redis:setex(ELKAYEB.."ELKAYEB:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
• ارسل الان النص
• يمكنك اضافه :
• `#username` ‹- اسم المستخدم
...
Redis:del(ELKAYEB.."ELKAYEB:Set:Id:Group"..msg.chat_id)
...
Redis:del(ELKAYEB.."ELKAYEB:DevelopersQ:Groups") 
...
Redis:del(ELKAYEB.."ELKAYEB:Developers:Groups") 
...
Redis:del(ELKAYEB.."ELKAYEB:TheBasics:Group"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Originators:Group"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Managers:Group"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Addictive:Group"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:Distinguished:Group"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:JabwaAll:Groups") 
...
Redis:del(ELKAYEB.."ELKAYEB:ktmAll:Groups") 
...
Redis:del(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(ELKAYEB.."ELKAYEB:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(ELKAYEB.."ELKAYEB:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(ELKAYEB.."ELKAYEB:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(ELKAYEB.."ELKAYEB:List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود ⇧⇩\n⩹•••⊶❲∆ 𝐀𝐋𝐃𝐄𝐌𝐎𝐍 ∆❳⊷•••⩺\n"
for k,v in pairs(list) do
if Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف• "
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›【 "..v.." 】-›【 "..db.." 】\n"
end
...
Redis:set(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(ELKAYEB.."ELKAYEB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(ELKAYEB.."ELKAYEB:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Gif"..v)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:vico"..v)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:stekr"..v)     
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Text"..v)   
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Photo"..v)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Video"..v)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:File"..v)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Audio"..v)
Redis:del(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:video_note"..v)
Redis:del(ELKAYEB.."ELKAYEB:List:Rd:Sudo")
end
...
text = "\n• قائمة الردود العامه ⇧⇩\n⩹•••⊶❲∆ 𝐀𝐋𝐃𝐄𝐌𝐎𝐍 ∆❳⊷•••⩺\n"
for k,v in pairs(list) do
if Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:File"..v) then
db = "ملف• "
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(ELKAYEB.."ELKAYEB:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›【 "..v.." 】-›【 "..db.." 】\n"
end
...
Redis:set(ELKAYEB.."ELKAYEB:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(ELKAYEB.."ELKAYEB:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(ELKAYEB.."SendBcBot") then
...
Redis:setex(ELKAYEB.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(ELKAYEB.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(ELKAYEB.."ELKAYEB:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(ELKAYEB.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(ELKAYEB.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local Added_Me = Redis:get(ELKAYEB.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if Redis:get(ELKAYEB.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
local rep = msg.id/2097152/0.5
local m = rep +1
...
Redis:del(ELKAYEB.."youtube"..msg.sender.user_id..msg_chat_id)
end
if Redis:get(ELKAYEB.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = rep +1
https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/youtube7odabot/7951&reply_to_message_id="..rep)
...
sec = time.sec
local_time = hour..":"..min
list_zkr = Redis:smembers(ELKAYEB.."ChekBotAdd")

if local_time then
if local_time == "0:0" and not Redis:get(ELKAYEB.."0:done") then -- الساعه 12 منتصف الليل 
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."0:done", true)
for i = 1 , 23 ,1 do 
Redis:del(ELKAYEB..i..":done")
end
end
if local_time == "1:0" and not Redis:get(ELKAYEB.."1:done") then -- الساعه 1 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."1:done", true)
end
if local_time == "2:0" and not Redis:get(ELKAYEB.."2:done") then -- الساعه 2 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."2:done", true)
end
if local_time == "3:0" and not Redis:get(ELKAYEB.."3:done") then -- الساعه 3 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."3:done", true)
end
if local_time == "4:0" and not Redis:get(ELKAYEB.."4:done") then -- الساعه 4 بعد منتصف الليل
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."4:done", true)
end
if local_time == "5:0" and not Redis:get(ELKAYEB.."5:done") then -- الساعه 5 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."5:done", true)
end
if local_time == "6:0" and not Redis:get(ELKAYEB.."6:done") then -- الساعه 6 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."6:done", true)
end
if local_time == "7:0" and not Redis:get(ELKAYEB.."7:done") then -- الساعه 7 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."7:done", true)
end
if local_time == "8:0" and not Redis:get(ELKAYEB.."8:done") then -- الساعه 8 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."8:done", true)
end
if local_time == "9:0" and not Redis:get(ELKAYEB.."9:done") then -- الساعه 9 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."8:done", true)
end
if local_time == "10:0" and not Redis:get(ELKAYEB.."10:done") then -- الساعه 10 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."10:done", true)
end
if local_time == "11:0" and not Redis:get(ELKAYEB.."11:done") then -- الساعه 11 صباحا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."11:done", true)
end
if local_time == "12:0" and not Redis:get(ELKAYEB.."12:done") then -- الساعه 12 ظهرا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","html",true)  
end
Redis:set(ELKAYEB.."12:done", true)
end
if local_time == "13:0" and not Redis:get(ELKAYEB.."13:done") then -- الساعه 1 مسائا
for k,v in pairs(list_zkr) do
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."13:done", true)
end
if local_time == "14:0" and not Redis:get(ELKAYEB.."14:done") and not Redis:get(ELKAYEB.."14:done") then -- الساعه 2 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)
end
Redis:set(ELKAYEB.."14:done", true)
end
if local_time == "15:0" and not Redis:get(ELKAYEB.."15:done") then -- الساعه 3 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."15:done", true)
end
if local_time == "16:0" and not Redis:get(ELKAYEB.."16:done") then -- الساعه 4 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."16:done", true)
end
if local_time == "17:0" and not Redis:get(ELKAYEB.."17:done") then -- الساعه 5 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."17:done", true)
end
if local_time == "18:0" and not Redis:get(ELKAYEB.."18:done") then -- الساعه 6 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."18:done", true)
end
if local_time == "19:0" and not Redis:get(ELKAYEB.."19:done") then -- الساعه 7 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."19:done", true)
end
if local_time == "20:0" and not Redis:get(ELKAYEB.."20:done") then -- الساعه 8 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."20:done", true)
end
if local_time == "21:0" and not Redis:get(ELKAYEB.."21:done") then -- الساعه 9 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."21:done", true)
end
if local_time == "22:0" and not Redis:get(ELKAYEB.."22:done") then -- الساعه 10 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."22:done", true)
end
if local_time == "23:0" and not Redis:get(ELKAYEB.."23:done") then -- الساعه 11 مسائا
for k,v in pairs(list_zkr) do 
LuaTele.sendText(v,0, "اشهد ان لا اله الا الله وان سيدنا محمد رسول الله","md",true)  
end
Redis:set(ELKAYEB.."23:done", true)
end
end
...
Redis:set(ELKAYEB..'ELKAYEB:GetTexting:DevELKAYEB'..msg_chat_id..':'..msg.sender.user_id,true)
...
local TextingDevELKAYEB = Redis:get(ELKAYEB..'ELKAYEB:Texting:DevELKAYEB')
if TextingDevELKAYEB then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevELKAYEB,"md",true)  
else
...
if text == "صورتي" then
if Redis:get(ELKAYEB.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
if photo.total_count > 0 then
...
photo = "https://t.me/UU7OQ"
local T =[[
╔━━━━━━━━━━━━━━━╗ 
┇⦑ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ѕᴏụʀᴄᴇ ELKAYEB⦒ 
╚━━━━━━━━━━━━━━━╝ 
]] 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ELKAYEB⦒', url = "https://t.me/UU7OQ"},{text = '∆ ＳＡＶＯ ∆', url = "https://t.me/s_a_s_a_3li"}
},
{
{text = '∆ 𝚂𝙾𝚄𝚁𝙲𝙴 ELKAYEB ∆', url = "https://t.me/UU7OQ"}
},
...
elseif text == 'سافو' or text == 'مصطفي' or text == 'المبرمج سافو' then
photo = "https://t.me/s_a_s_a_3li"
local Name = 'اليك المبرمج سافو اتبع الازرار لتواصل معاه ☑️ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '∆ ＳＡＶＯ ∆', url = "https://t.me/s_a_s_a_3li"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'ايهاب' or text == 'المبرمج عازف' or text == 'عازف' then
photo = "https://t.me/X_X_A_Z_F_X_X2"
local Name = 'اليك المبرمج عازف اتبع الازرار لتواصل معاه ☑️'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '∆ AZZF ∆', url = "https://t.me/X_X_A_Z_F_X_X2"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'آبن آلجمل' or text == 'المبرمج آبن آلجمل' or text == 'ابن الجمل' then
photo = "https://t.me/DAD_ALGAMAL"
local Name = 'اليك المبرمج عازف اتبع الازرار لتواصل معاه ☑️'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '∆ ALGAMAL ∆', url = "https://t.me/DAD_ALGAMAL"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,'• اليك قسم الالعاب من سورس سافو ',"md",false, false, false, false, reply_markup)
end
if Redis:get(ELKAYEB.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
if Redis:get(ELKAYEB.."brgi"..msg.sender.user_id) == "sendbr" then
...
if Redis:get(ELKAYEB.."Status:kool"..msg.chat_id) then
...
if tonumber(Message_Reply.sender.user_id) == tonumber(ELKAYEB) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(ELKAYEB..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(ELKAYEB..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(ELKAYEB..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(ELKAYEB..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(ELKAYEB..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(ELKAYEB..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if Redis:sismember(ELKAYEB..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(ELKAYEB..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(ELKAYEB..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(ELKAYEB..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(ELKAYEB..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(ELKAYEB..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(ELKAYEB..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(ELKAYEB..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(ELKAYEB..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if not Redis:get(ELKAYEB.."ELKAYEB:Sasa:Jeka"..msg_chat_id) then
...
data = {
{
{text = '∆ ??𝙾𝚄??𝙲𝙴 ELKAYEB ∆', url = 't.me/UU7OQ'}, 
},
}
}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(ELKAYEB..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n • عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:setex(ELKAYEB.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(ELKAYEB.."Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id," • تم حذف اسم البوت ","md",true)   
end
if text == 'بوت' or text == 'البوت' then
local photo = LuaTele.getUserProfilePhotos(ELKAYEB)
local Jabwa = LuaTele.getUser(ELKAYEB)
local Namebot = (Redis:get(ELKAYEB.."Name:Bot") or "سافو")
local BotName = {
...
if text == (Redis:get(ELKAYEB.."Name:Bot") or "سافو") then
local photo = LuaTele.getUserProfilePhotos(ELKAYEB)
local Jabwa = LuaTele.getUser(ELKAYEB)
local Namebot = (Redis:get(ELKAYEB.."Name:Bot") or "سافو")
local BotName = {
...
if not msg.ControllerBot and not Redis:set(ELKAYEB.."ELKAYEB:LeftBot") then
...
x = x + 1
Redis:srem(ELKAYEB..'ELKAYEB:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,ELKAYEB)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*• البوت عضو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(ELKAYEB..'ELKAYEB:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(ELKAYEB..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(ELKAYEB..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(ELKAYEB..'ELKAYEB:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(ELKAYEB.."ELKAYEB:Game:Smile"..msg.chat_id,SM)
...
Redis:set(ELKAYEB.."ELKAYEB:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(ELKAYEB.."ELKAYEB:Game:Alam"..msg.chat_id,name)
...
Redis:set(ELKAYEB.."ELKAYEB:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(ELKAYEB.."ELKAYEB:Status:Games"..msg.chat_id) then
Redis:del(ELKAYEB.."ELKAYEB:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(ELKAYEB.."ELKAYEB:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(ELKAYEB.."ELKAYEB:Status:Games"..msg.chat_id) then
Redis:del(ELKAYEB.."ELKAYEB:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(ELKAYEB.."ELKAYEB:Game:Reflection"..msg.chat_id,name)
...
Redis:set(ELKAYEB.."ELKAYEB:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(ELKAYEB.."ELKAYEB:Game:Difference"..msg.chat_id,name)
...
Redis:set(ELKAYEB.."ELKAYEB:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(ELKAYEB.."ELKAYEB:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(ELKAYEB.."ELKAYEB:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(ELKAYEB..'ELKAYEB:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(ELKAYEB.."ELKAYEB:Start:Bot") then
local CmdStart = '*\n• أهلآ بك في بوت '..(Redis:get(ELKAYEB.."ELKAYEB:Name:Bot") or "سافو")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(ELKAYEB.."ELKAYEB:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(ELKAYEB.."ELKAYEB:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(ELKAYEB.."ELKAYEB:Start:Bot") 
...
Redis:setex(ELKAYEB.."ELKAYEB:Change:ELKAYEB:Name:Bot"..msg.sender.user_id,300,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل لي الاسم الان ","md",true)  
end
if text == '【 حذف اسم البوت 】' then 
if not msg.ControllerBot then 
...
Redis:del(ELKAYEB.."ELKAYEB:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف اسم البوت ","md",true)   
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") then
if not msg.ControllerBot then 
...
Redis:setex(ELKAYEB.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
• ارسل اذاعتك لتثبيت في الجروبات
• للخروج من الامر ارسل【الغاء】
*]],"md",true)  
...
if not msg.ControllerBot then
if Redis:get(ELKAYEB.."ELKAYEB:TwaslBot") and not Redis:sismember(ELKAYEB.."ELKAYEB:Jabwa:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(ELKAYEB.."ELKAYEB:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(ELKAYEB.."ELKAYEB:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(ELKAYEB..'ELKAYEB:Jabwa:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'• تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(ELKAYEB..'ELKAYEB:Jabwa:In:Tuasl',Info_User)  
...
Redis:srem(ELKAYEB.."ELKAYEB:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(ELKAYEB..'*'..'-100'..data.supergroup.id..'*')
Redis:del(ELKAYEB.."ELKAYEB:List:Manager"..'-100'..data.supergroup.id)
Redis:del(ELKAYEB.."ELKAYEB:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(ELKAYEB.."ELKAYEB:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(ELKAYEB.."ELKAYEB:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(ELKAYEB) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(ELKAYEB..'ELKAYEB:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == ELKAYEB then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(ELKAYEB..'ELKAYEB:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(ELKAYEB.."ELKAYEB:Lock:edit"..data.chat_id) then
...
Redis:del(ELKAYEB.."ELKAYEB:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(ELKAYEB.."ELKAYEB1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(ELKAYEB.."ELKAYEB:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(ELKAYEB.."ELKAYEB:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(ELKAYEB.."ELKAYEB1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(ELKAYEB.."ELKAYEB:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(ELKAYEB.."ELKAYEB:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(ELKAYEB.."ELKAYEB:Num:Add:Games"..ChatId..IdUser, 1)  
...
• ارسل ما تريد تحميله
*]]
Redis:set(ELKAYEB.."youtube"..IdUser..ChatId,'mp3')
...
• ارسل ما تريد تحميله
*]]
Redis:set(ELKAYEB.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:JabwaId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'belalmadeson'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:JabwaId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(ELKAYEB.."ELKAYEB:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(ELKAYEB.."ELKAYEB:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(ELKAYEB.."ELKAYEB:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(ELKAYEB.."ELKAYEB:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(ELKAYEB..'ELKAYEB:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(ELKAYEB.."ELKAYEB:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:JabwaGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"*• تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ELKAYEB.."ELKAYEB:SilentGroup:Group"..ChatId) 
