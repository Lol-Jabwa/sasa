...
ControllerAll = false
local ListSudos ={Sudo_Id,1614314857}  
...
if photo.total_count > 0 then
local TestText = "*• ِٰ𝗢ِٰ𝗪ِٰ𝗡ِٰ𝗘ِٰ𝗥ِٰ  ِٰ𝗚ِٰ𝗥ِٰ𝗢ِٰ𝗨ِٰ𝗣ِٰ𝗦ِٰ  ↫ *  ["..Jabwa.first_name.."](tg://user?id="..Jabwa.id..")\n*• ʙɪᴏ ↫ * [「 "..Bio.." 」]"
keyboardd = {} 
...
local abnj = " \n*• ɴᴀᴍᴇ ↫ * "..Jabwayt.result.first_name.." \n"
keyJabwayt = {} 
...
{
{text = 'ᯓ sᴏᴜʀᴄᴇ ɢᴏʟᴅ', url = "http://t.me/AKJA0"}
},
{
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'صورص' then
photo = "https://t.me/JABWA"
local Name = '*المطور جابوا مطور السورس لو حاابب تتواصل معاه بالاسفل ⬇️*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• ᴍʏ ᴅᴇᴠ •', callback_data = IdUser..'/Re@'},
},
{
{text = '• ᴍʏ ᴄʜᴀɴɴᴇʟ •', callback_data = IdUser..'/Re@'},
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
