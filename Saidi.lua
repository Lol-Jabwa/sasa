...
ControllerAll = false
local ListSudos ={Sudo_Id,1614314857,1072528028}  
...
NamesBot = (Redis:get(Saidi.."Name:Bot") or "جولد")
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = 'ᯓ sᴏᴜʀᴄᴇ ɢᴏʟᴅ', url = "http://t.me/AKJA0"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if photo.total_count > 0 then
local TestText = "*⋄︙Owner Group ↬ *  ["..Jabwa.first_name.."](tg://user?id="..Jabwa.id..")\n*⋄︙Bio ↬ * [「 "..Bio.." 」]"
keyboardd = {} 
...
if photo.total_count > 0 then
local TestText = "* ⋄︙Here is the dev bot*\n*⋄︙Name ↬*  ["..Jabwa.first_name.."](tg://user?id="..Sudo_Id..")\n*⋄︙Bio ↬ * ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..Jabwa.username..""},
...
local abnj = " \n*⋄︙Name ↬ * "..Jabwayt.result.first_name.." \n"
keyJabwayt = {} 
...
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local Jabwa_ns = '- 𝘛𝘩𝘦𝘴𝘦 𝘢𝘳𝘦 𝘺𝘰𝘶𝘳 𝘱𝘩𝘰𝘵𝘰𝘴.'
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
...
{
{text = '𝐄𝐱𝐩 𝐁𝐨𝐭', url = "https://t.me/Exp_Gold/47"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'جافا' or text == 'عتتمرو' or text == 'مبرمجاا السورس' then
...
if text == 'اوامر التاك' or text == 'تاك' then
...
data = {
{
{text = 'كيفيه استخدام التاك', url = 'https://t.me/Exp_Gold/49?single'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*• لعمل التاك ارسل @all + الكلام ، وليقاف عمليه التاك ارسل ايقاف المنشن*',"md",false, false, false, false, reply_markup)
end
if text == 'اوامر اشتراك المجموعه' or text == 'اوامر الاشتراك' then
if not Redis:get(Saidi.."Saidi:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
data = {
{
{text = 'شرح الميزه', url = 'https://t.me/Exp_Gold/49?single'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*• اضغط بالاسفل للشرح*',"md",false, false, false, false, reply_markup)
end
if text == 'بوت الحذف' or text == 'روابط الحذف' or text == 'رابط الحذف' then
if not Redis:get(Saidi.."Saidi:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
data = {
{
{text = '• Telegram', url = "https://my.telegram.org/auth?to=delete"},{text = '• Bot deletion', url = "t.me/LC6BOT"},
},
}
{text = '• instagram', url = "https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = '• Bot deletion', url = "t.me/LC6BOT"},
},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'*• اليك بعض روابط حذف حسابات السوشال*',"md",false, false, false, false, reply_markup)
end
if text == 'صفحه' or text == 'الصافحه' then
if not Redis:get(Saidi.."Saidi:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
data = {
{
{text = 'شرح الميزه', url = 'https://t.me/Exp_Gold/51'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*• ارسل صفحه + الرقم لجلب الصفحه من القران الكريم*',"md",false, false, false, false, reply_markup)
end
}local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'جابوا' or text == 'المطور جابوا' or text == 'مطور السورس' then
photo = "https://t.me/JABWA"
local Name = '*المطور جابوا مطور السورس لو حاابب تتواصل معاه بالاسفل ⬇️*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• 𝗝ٰٖ𝗔ٰٖ𝗕ٰٖ𝗪ٰٖ𝗔ٰٖ ➪🇳🇱•', url = "https://t.me/JABWA"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '• قناه السورس', url = 't.me/AKJA0'}, {text = '• الاضافات', data = msg.sender.user_id..'/java11'},
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
if text == (Redis:get(Saidi.."Name:Bot") or 'جولد').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⌯ هاذا الامر يخص 「 '..Controller_Num(3)..' 」* ',"md",true)  
end
...
local Mostafa = (Redis:get(Saidi.."Name:Bot") or "جولد")
local Jabwa = LuaTele.getUser(Saidi)
local bain = LuaTele.getUser(msg.sender.user_id)
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Saidi..'Channel:Join')}, },}}
...
local CmdStart = '\n*⋄︙ مرحبا انا بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "جولد")..
'\n⋄︙ اختصاص البوت حماية المجموعات'..
'\n⋄︙ احتوي ايضا علي مميزات عديده'..
'\n⋄︙ لتفعيلي ارفعني مشرف وارسل تفعيل'..
'\n⋄︙ لفتح الكيبورد ارسل /keb ؛ الكيبورد - ويمكنك استخدمه ايضا في المجموعه*'
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
elseif Text and Text:match('(%d+)/java11') then
local UserId = Text:match('(%d+)/java11')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '• الالعاب', data = IdUser..'/normgm'}, {text = '• الاضافات', data = msg.sender.user_id..'/java11'},
},
{
{text = '• الصفحه الرئيسيه', data = IdUser..'/helpall'},
},
}
}
local TextHelp = [[*
⌯ لاستخدام المميزات اتبع مايلي .↓
•────•──────•────•
⌯ /keb ↫ لعرض كيبورد الاعضاء في الجروب.↓
•────•──────•────•
...
⌯ صفحه + الرقم ↫ لجلب الصحفه من المصحف
...
•────•──────•────•
⌯ الحساب + الايدي ↫ لعرض حساب الشخص من خلال الايدي الخاص به
⌯ مثال: الحساب 1614314857
•────•──────•────•
⌯ @all + الكلام لعمل منشن لجميع الاعضاء
⌯ ايقاف المنشن: لإيقاف التاك المستمر
•────•──────•────•
.
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
