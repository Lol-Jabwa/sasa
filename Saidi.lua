...
msg.Name_Controller = 'المبرمج بيبر'
...
{
{text = '.َ ‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻 ⁦⁦.𖨬', url='https://t.me/QQWGT2'},
},
}
}
...
NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "الافضل")
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج بيبر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج بيبر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
...
if Controller(msg_chat_id,UserId) == 'المبرمج بيبر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ⦁ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
...
if ban.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @QQWGT2"..Creator.."\n"
else
...
data = {
{
{text = '.َ ‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻 ⁦⁦.𖨬', url = 't.me/QQWGT2'}, 
},
}
}
...
photo = "https://t.me/DEV_JABWA/85"
local T =[[
⦑𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻⦒ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝑩𝑬𝑷𝑷𝑬𝑹 ⁦. 𓌗', url = "https://t.me/QQWGT"},{text = '˹  𝑻𝑾𝑨𝑺𝑶𝑳 ⁦. 𓌗', url = "https://t.me/AA_Q19bot"}
},
{
{text = '.َ ‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻 ⁦⁦.𖨬', url = "https://t.me/QQWGT2"}
},
...
elseif text == 'بيبر' or text == 'مبرمج السورس' or text == 'صاحب السورس' then
photo = "https://t.me/QQWGT"
local Name = 'المبرمج بيبر لو حابب تتواصل معاه بلاسفل'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝑩𝑬𝑷𝑷𝑬𝑹 ⁦. 𓌗', url = "https://t.me/QQWGT"}
},
}
local msgg = msg_id/2097152/0.5
...
return LuaTele.sendText(msg_chat_id,msg_id,'⦁ اليك قسم الالعاب من سورس الافضل ⦁',"md",false, false, false, false, reply_markup)
end
...
if text == (Redis:get(Saidi.."Saidi:Name:Bot") or " ") then
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or " ")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الافضل؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الافضل؟ ", 
"كم مره حبيت؟ ", 
...
local CmdStart = '*\n ⦁ أهلآ بك في بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "الافضل")..
...
MahiSaidiext = '* ⦁ الف مبروك حظك حلو اليوم\n ⦁ فزت ويانه وطلعت المحيبس بل عظمه رقم『'..NumMahibes..'』*'
else
MahiSaidiext = '* ⦁ للاسف لقد خسرت المحيبس بالعظمه رقم 『'..NumMahibes..'』\n ⦁ جرب حضك ويانه مره اخره*'
end
...
return LuaTele.editMessageText(ChatId,Msg_id,MahiSaidiext, 'md', true, false, reply_markup)
end
