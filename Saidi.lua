...
ControllerAll = false
local ListSudos ={Sudo_Id,1965534755,5055146093}  
...
HELPBEVQ = Redis:sismember(Saidi.."HELPBEVQ:Groups",UserId) 
...
os.execute('wget https://UUJEBH/Jabwa/Saidi.lua')
...
data = {
{
{text = 'تأكيد الأمر', data = msg.sender.user_id..'/yaaaaa'}, {text = 'الغاء الأمر', data = msg.sender.user_id..'/Noooo'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*\n ✧ يرجاء تأكيد الأمر بضغط علي الازرار *',"md",false, false, false, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =ban.first_name,url = "https://t.me/"..Jabwa.username..""}, },}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =bain.bio,url = "https://t.me/"..Jabwa.username..""}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, 'بايو -› '..Bio, 'md', false, false, false, false, reply_markup)
end
if text == 'بايو' then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =first_name,url = "https://t.me/"..get_bio.username..""}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, 'بايو : '..bio, 'md', false, false, false, false, reply_markup)
end
if text == '77' then
local user_info = LuaTele.getUser(msg.sender.user_id)
...
if not Redis:sismember(Saidi.."HELPBEVQ:Groups",Jabwaa.id) then
...
Redis:del(Saidi.."HELPBEVQ:Groups", Jabwaa.id)
Redis:del(Saidi.."id:HELPBEVQ:Groups", Jabwaa.id)
...
if Redis:sismember(Saidi.."HELPBEVQ:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Saidi.."HELPBEVQ:Groups")
...
local Info_Members = Redis:smembers(Saidi.."kramp:Groups") 
if #Info_Members == 0 then
...
if text and text:match("^(.*)$") then
if Redis:get(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
...
Redis:set(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
if Redis:get(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(Saidi.."Saidi1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(Saidi.."Saidi1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Saidi.."Se1t:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
return LuaTele.sendText(msg_chat_id,msg_id,"*✧ انت دخلت عبر الرابط يقميل*","md",true) 
end
end
...
data = {
{
{text = '𓄼• تعديل الصلاحيات •𓄹', data = msg.sender.user_id..'/groupNumseteng//'..Jabwaa.id}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id, "* ✧ صلاحيات المستخدم *", 'md', false, false, false, false, reply_markup)
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹',url="https://t.me/S_a_i_d_i"}}
}
local msg_id = msg.id/2097152/0.5
...
{
{text = 'العاب الالكترونيه', data = msg.sender.user_id..'/degm'}, 
},
{
{text = '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹', url = 't.me/S_a_i_d_i'}, 
},
...
local CmdStart = '*\n ✧ أهلا بك في بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "صعيدي")..
...
keyboard.inline_keyboard = {
{
{text = '𓄼• جـابــوا •𓄹', url = 't.me/J_A_B_W_A'},{text = '𓄼• جـيكا •𓄹', url = 't.me/Dev_Jeka'}, 
},
{
{text = '𓄼• عوز بــوت •𓄹', url = 't.me/Dev_Jeka'},{text = '𓄼• تواصـل السـورس •𓄹', url = 't.me/TEMM_SAIDl'}, 
},
{
...
data = {
{
{text = '〘 المبرمج جيكا 〙',type = 'text'},{text = '〘 المطور جابوا 〙',type = 'text'},
},
{
...
Redis:del(Saidi.."Broadcasting:Groups:Pin"..ChatId..""..IdUser) 
Redis:del(Saidi.."Broadcasting:Groups"..IdUser..":"..ChatId)
Redis:del(Saidi.."Broadcasting:Users"..IdUser..":"..ChatId)
Redis:del(Saidi.."Broadcasting:Groups:Fwd"..IdUser..":"..ChatId)
Redis:del(Saidi.."Broadcasting:Users:Fwd"..IdUser..":"..ChatId)
...
Redis:del(Saidi.."Se1t:Rd"..IdUser..":"..ChatId)
...
local Jabwa = LuaTele.getUser(IdUser)
if photo.total_count > 1 then
local Jabwa_ns = '𝚑𝚎??𝚎 𝚊𝚛𝚎 𝚢𝚘𝚞𝚛 𝚙𝚑𝚘𝚝𝚘𝚜'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼• اخفاء الامر •𓄹', callback_data =IdUser..'/delAmr'}, 
...
{
{text = '𓄼• مسح المكتومين عام •𓄹', data = IdUser..'/JabwaII'}, {text = '𓄼• مسح المحظورين عام •𓄹', data = IdUser..'/Redisa'}, 
},
{
{text = '𓄼• القائمه الرئيسيه •𓄹', data =IdUser..'/'.. 'helpall'}
},
...
elseif Text and Text:match('(%d+)/Jabwa:Jeka_Jabwa') then
local UserId = Text:match('(%d+)/Jabwa:Jeka_Jabwa')
if tonumber(IdUser) == tonumber(UserId) then
...
elseif Text and Text:match('(%d+)/Jabwa:Jeka_bian') then
local UserId = Text:match('(%d+)/Jabwa:Jeka_bian')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Saidi.."Jabwa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
