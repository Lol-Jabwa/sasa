...
ktmall = Redis:sismember(Saidi.."Sasa:Groups",UserId) ,
...
if text and Redis:get(Saidi.."Status:ReplySudo"..msg_chat_id) then
...
if text and Redis:get(Saidi.."Status:Reply"..msg_chat_id) then
...
Redis:set(Saidi.."Status:Id"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:Reply"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:BanId"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Saidi.."Status:IdPhoto"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local Info_Members = Redis:smembers(Saidi.."Sasa:Groups") 
if #Info_Members == 0 then
...
Redis:set(Saidi.."Status:Jabwa"..msg_chat_id,true) 
...
Redis:del(Saidi.."Status:Jabwa"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على جوافه الكلب *","md",true)  
end
if UserId == "5055146093" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على المبرمج جيكا *","md",true)  
end
...
Rink = 1
elseif Redis:sismember(Saidi.."Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Saidi.."TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Saidi.."Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Saidi.."Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Saidi.."Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Saidi.."Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
if not msg.ControllerBot then
if Redis:get(Saidi.."Saidi:TwaslBot") and not Redis:sismember(Saidi.."Jabwa:In:Tuasl",msg.sender.user_id) then
