...
{
{text = '𝐄𝐱𝐩 𝐁𝐨𝐭', url = "http://t.me/T6llbot?start"}
},
}
local msgg = msg_id/2097152/0.5
...
{
{text = 'الاضافات', data = IdUser..'/help11'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
▬▭▬▭▬▭▬▭▬▭▬ 
*]],"md",false, false, false, false, reply_markup)
elseif text == 'الالعاب' or text == 'الالعاب التسليه' or text == 'ااااااسنسن' or text == 'الالعاب الالكترونيه' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⌯ هاذا الامر يخص 「 '..Controller_Num(7)..' 」* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
elseif Text and Text:match('(%d+)/help11') then
...
data = {
{
{text = '• القائمه الرئيسيه', data = IdUser..'/help6'},{text = '• الالعاب', data = IdUser..'/normgm'},
},
}
}
local TextHelp = [[*
