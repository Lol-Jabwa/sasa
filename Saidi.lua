...
ControllerAll = false
local ListSudos ={Sudo_Id,1965534755,1614314857,5055146093}  
...
return{
JabwaAll = Redis:sismember(Saidi.."Saidi:JabwaAll:Groups",UserId) ,
ktmall = Redis:sismember(Saidi.."Saidi:ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(Saidi.."Saidi:JabwaGroup:Group"..ChatId,UserId) ,
...
local Num_Msg_Saidi = Redis:hget(Saidi.."Saidi:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_Saidi = Redis:hget(Saidi.."Saidi:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
local bot = '* ◄ مرحبا انا بوت '..N..'\n◄ اختصاصي حمايه مجموعات\n◄ لتفعيله ارفعه مشرف واكتب تفعيل\n◄ معرف المطور: @'..UserSudo..'*'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⌯ 𝗧𝗲𝗔𝗺 𝗚𝗼𝗟𝗱', url = 't.me/AKJA0'}, 
},
}
...
if Redis:get(Saidi.."Saidi:Jabwa:Jabwa" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '「 الغاء الامر 」' then   
Redis:del(Saidi.."Saidi:Jabwa:Jabwa" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
{
{text = 'ᯓ sᴏᴜʀᴄᴇ ɢᴏʟᴅ', url='https://t.me/AKJA0'},
},
}
}
...
download('https://raw.githubusercontent.com/UUJEBH/Java/master/Saidi.lua','Saidi.lua')
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌯ الاسم ↜ 「*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*」\n⌯ تم التفعيل سابقآ *',"md",true)  
else
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
Redis:set(Saidi.."Saidi:Status:Id"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:Reply"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:JabwaId"..msg_chat_id,true) ;Redis:set(Saidi.."Saidi:Status:SetId"..msg_chat_id,true) 
...
local Texting = {'𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻',"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 ","𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻","𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻","𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",}
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم تنزيله متوحد مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم تنزيله متوحد من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "كلب" then
if not Redis:sismember(Saidi.."tolift:kupa"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم تنزيله كلب مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:kupa"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم تنزيله كلب من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if not Redis:sismember(Saidi.."tolift:krab"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم تنزيله قرد مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:krab"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم تنزيله قرد من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "قلبي" then
if not Redis:sismember(Saidi.."tolift:wuyb"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم تنزيله في قلبك مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:wuyb"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم تنزيله في قلبك ").Reply,"md",true)  
end
end
if TextMsg == "بقره" then
if not Redis:sismember(Saidi.."tolift:pakra"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم تنزيله بقره مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:pakra"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم تنزيله بقره من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "ارمله" then
if not Redis:sismember(Saidi.."tolift:armuyo"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم تنزيله ارمله مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:armuyo"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم تنزيله ارمله من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "خول" then
if not Redis:sismember(Saidi.."tolift:iabtr"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم تنزيله خول مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:iabtr"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم تنزيله خول من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "حمار" then
if not Redis:sismember(Saidi.."tolift:rplkn"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم تنزيله حمار مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:rplkn"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم تنزيله حمار من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "مزه" then
if not Redis:sismember(Saidi.."tolift:mjag"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم تنزيله مزه مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:mjag"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم تنزيله مزه من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "وتكه" then
if not Redis:sismember(Saidi.."tolift:etaka"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم تنزيله وتكه مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:etaka"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم تنزيله وتكه من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "ابني" then
if not Redis:sismember(Saidi.."tolift:qnau"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم تنزيله ابني مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:qnau"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم تنزيله ابني من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "بنتي" then
if not Redis:sismember(Saidi.."tolift:danta"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم تنزيله بنتي مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:danta"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم تنزيله بنتي من الجروب ").Reply,"md",true)  
end
end
if TextMsg == "خاين" then
if not Redis:sismember(Saidi.."tolift:javbn"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم تنزيله خاين مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."tolift:javbn"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم تنزيله خاين من الجروب ").Reply,"md",true)  
end
end
end
...
if Redis:sismember(Saidi.."tolift:kupa"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:kupa"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:krab"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:krab"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "قلبي" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:wuyb"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:wuyb"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").Reply,"md",true)  
end
end
if TextMsg == "بقره" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:pakra"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:pakra"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "ارمله" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:armuyo"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:armuyo"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "خول" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:iabtr"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:iabtr"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "حمار" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:rplkn"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:rplkn"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "مزه" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:mjag"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:mjag"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "وتكه" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:etaka"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:etaka"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "ابني" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:qnau"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:qnau"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "بنتي" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:danta"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:danta"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").Reply,"md",true)  
end
end
if TextMsg == "خاين" then
if ChannelJoin(msg) == false then
...
if Redis:sismember(Saidi.."tolift:javbn"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."tolift:javbn"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").Reply,"md",true)  
end
end
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*⌯ لا يوجد متوحدين في الجروب *","md",true)  
end
ListMembers = '\n*⌯ قائمه المتوحدين ↶*\n •━═━═━═━═━═━═━═━═━•*\n'
for k, v in pairs(Info_Members) do
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = 'مسح المتوحدين', data = msg.sender.user_id..'/Delkholat'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(Saidi.."tolift:kupa"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = 'مسح الكلاب', data = msg.sender.user_id..'/Delkholat'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(Saidi.."tolift:krab"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = 'مسح القرود', data = msg.sender.user_id..'/Delkholat'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
-----------تاك تسلية-------
...
local Info_Members = Redis:smembers(Saidi.."Saidi:JabwaAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Saidi.."Saidi:Status:JabwaId"..msg_chat_id,true) 
...
Redis:set(Saidi.."Saidi:Jabwa:Jeka"..msg_chat_id,true) 
...
Redis:del(Saidi.."Saidi:Status:yt"..msg.chat_id)
...
Redis:set(Saidi.."Saidi:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'⌯ تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(Saidi.."Saidi:Status:yt"..msg.chat_id) then
...
Redis:del(Saidi.."Saidi:Status:JabwaId"..msg_chat_id) 
...
if TextMsg == 'ردود السورس' then
Redis:del(Saidi.."Saidi:Jabwa:Jeka"..msg_chat_id) 
...
if Redis:sismember(Saidi.."Saidi:JabwaAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."Saidi:JabwaAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Saidi.."Saidi:JabwaAll:Groups",UserId_Info.id) then
...
Redis:srem(Saidi.."Saidi:JabwaAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Saidi.."Saidi:Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'Jabwaned',0)
...
if not Redis:sismember(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌯ تم الغاء طرده من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Saidi.."Saidi:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Saidi.."Saidi:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Saidi.."Saidi:JabwaAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Saidi.."Saidi:JabwaAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
...
if not Redis:sismember(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Saidi.."Saidi:Jabwa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Saidi.."Saidi:Jabwa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Saidi.."Saidi:Jabwa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Saidi.."Saidi:Jabwa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'Jabwaned',0)
...
if not Redis:sismember(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Jabwa.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @AKJA0"..Creator.."\n"
else
...
local T = '*• 𝐎𝐰𝐧𝐞𝐫 𝐆𝐫𝐨𝐮𝐩 » *['..ban.first_name..'](tg://user?id='..ban.id..')**'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if photo.total_count > 0 then
local TestText = "*• 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 .*\n*• 𝐍𝐚𝐦𝐞 ➥ *  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n*• 𝐁𝐢𝐨 ➥ * ["..Bio.." ]\n"
keyboardd = {} 
...
if text == 'المبرمج جابوا' or text == 'جابوا' or text == 'اتتتتم' then  
...
if photo.total_count > 0 then
local TestText = "*• ᴅᴀᴠ ᴊᴀʙᴡᴀ •*\n*⑆┞ 𝐍𝐞𝐦𝐞↬ *  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n*⑆┞ 𝐁𝐢𝐨↬ * ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
...
if text == 'المبرمج جابوا' or text == 'جابوا' or text == 'مبرمج السورس' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
{
{text = 'تعطيل ردود السورس', data = IdUser..'/'.. 'mostaf_Jabwa'},{text = 'تفعيل ردود السورس', data = IdUser..'/'.. 'jeka_alone'},
},
{
...
if Redis:get(Saidi.."Saidi:Status:JabwaId"..msg.chat_id)  then
...
data = {
{
{text = 'ᯓ sᴏᴜʀᴄᴇ ɢᴏʟᴅ', url = 't.me/AKJA0'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌯ عذرا ارفع الشخص مشرف الاول ","md",true)  
end 
end
if text == 'تست' then
...
news = " "..GeId.result.custom_title.." "
else
news = "⌯ لا يوجد لك لقب"
end
if GeId.result.custom_title then
UserName = ' '..GeId.result.custom_title..' '
else
UserName = '⌯ لا يوجد لك لقب'
end
local UseName = ' '..UserName
local news = ' لقبك هوا :'..news
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:del(Saidi.."Saidi:JabwaAll:Groups") 
...
Redis:del(Saidi.."Saidi:JabwaGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(Saidi.."Saidi:Jabwa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌯ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(Saidi.."Saidi:Jabwa:Ahmed"..msg_chat_id) 
...
Redis:setex(Saidi.."Saidi:Jabwa:Jabwa" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
local ban_ns = '- 𝘛𝘩𝘦𝘴𝘦 𝘢𝘳𝘦 𝘺𝘰𝘶𝘳 𝘱𝘩𝘰𝘵𝘰𝘴.'
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
...
local Name = '*- 𝘏𝘦𝘭𝘭𝘰 𝘠𝘰𝘶𝘳 ↬* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*- 𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘛𝘰 𝘚𝘰𝘶𝘳𝘤𝘦 𝘎𝘰𝘭𝘥.*\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard.inline_keyboard = {
{
{text = 'ضغط للدخول', url = "https://t.me/LC6BOT"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if not Redis:get(Saidi.."Saidi:Jabwa:Jeka"..msg_chat_id) then
...
local CmdStart = '*\n⌯ اهلا بك انا بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "جولد")..
...
if not msg.ControllerBot then
if Redis:get(Saidi.."Saidi:TwaslBot") and not Redis:sismember(Saidi.."Saidi:Jabwa:In:Tuasl",msg.sender.user_id) then
...
{
{text = 'صورتك السابقه', callback_data =IdUser..'/ban1'},{text = 'صورتك القادمه', callback_data =IdUser..'/delAmr'}, 
},
}
...
{
{text = 'صورتك السابقه', callback_data =IdUser..'/ban2'},{text = 'صورتك القادمه', callback_data =IdUser..'/ban0'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = 'صورتك السابقه', callback_data =IdUser..'/ban3'},{text = 'صورتك القادمه', callback_data =IdUser..'/ban1'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = 'صورتك السابقه', callback_data =IdUser..'/ban4'},{text = 'صورتك القادمه', callback_data =IdUser..'/ban2'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = 'صورتك السابقه', callback_data =IdUser..'/ban5'},{text = 'صورتك القادمه', callback_data =IdUser..'/ban3'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = 'صورتك السابقه', callback_data =IdUser..'/ban6'},{text = 'صورتك القادمه', callback_data =IdUser..'/ban4'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = 'صورتك السابقه', callback_data =IdUser..'/ban7'},{text = 'صورتك القادمه', callback_data =IdUser..'/ban5'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = 'صورتك القادمه ', callback_data =IdUser..'/ban0'}, 
},
}
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
...
{
{text = '• مسح المكتومين عام', data = IdUser..'/JabwaII'}, {text = 'مسح المحظورين عام', data = IdUser..'/Redisa'}, 
},
{
{text = 'القائمه الرئيسيه', data =IdUser..'/'.. 'helpall'}
},
...
local TextHelp = [[*「 اهلا بك في اوامر المسح ↶ 」
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
elseif Text and Text:match('(%d+)/mostaf_Jabwa') then
local UserId = Text:match('(%d+)/mostaf_Jabwa')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."Saidi:Jabwa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع ➥', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."Saidi:Status:JabwaId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع ➥', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Saidi.."Saidi:Jabwa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع ➥', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Saidi.."Saidi:Status:JabwaId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'رجوع ➥', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Text and Text:match('(%d+)/Newadsudos') then
local UserId = Text:match('(%d+)/Newadsudos')
if tonumber(IdUser) == tonumber(UserId) then
LuaTele.editMessageText(ChatId,Msg_id,"*⌯ ارسل معرف المطور الاساسي مع @*","md",true) 
Redis:set(Saidi.."Saidi:AddSudosNew"..ChatId,true)
end
end
...
Redis:set(Saidi.."Change:Name:Bot"..msg.sender.user_id,300,true) 
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Saidi.."Saidi:JabwaGroup:Group"..ChatId) 
