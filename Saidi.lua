...
local N = (Redis:get(Saidi.."Saidi:Name:Bot") or "الديمون")
...
if Redis:get(Saidi.."Saidi:Game:Alam"..msg.chat_id) then
if text == Redis:get(Saidi.."Saidi:Game:Alam"..msg.chat_id) then
Redis:del(Saidi.."Saidi:Game:Alam"..msg.chat_id)
Redis:incrby(Saidi.."Saidi:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "الديمون")
...
Rink = 1
elseif Redis:sismember(Saidi.."Saidi:HELPBEVQ:Groups",msg.sender.user_id)  then
Rink = 1
...
data = {
{
{text = '∆ ??𝙾𝚄𝚁𝙲𝙴 𝙳𝙰𝙴𝙼𝙾𝙽 ∆', url = 't.me/SOURCE_F_L_D_N'}, 
},
}
}
...
local Namebot = (Redis:get(Saidi.."Name:Bot") or "الديمون")
local BotName = {
...
if text == (Redis:get(Saidi.."Name:Bot") or "الديمون") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local Jabwa = LuaTele.getUser(Saidi)
local Namebot = (Redis:get(Saidi.."Name:Bot") or "الديمون")
local BotName = {
...
Redis:set(Saidi.."Saidi:Game:Alam"..msg.chat_id,name)
...
local CmdStart = '*\n• أهلآ بك في بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "الديمون")..
