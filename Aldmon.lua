...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S Aldmon -X kill
screen -S Aldmon ./Aldmon
done
]])
Run:close()
...
return{
BanAll = Redis:sismember(Aldmon.."Aldmon:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Aldmon.."Aldmon:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Aldmon.."Aldmon:BanGroup:Group"..ChatId,UserId) ,
...
local Num_Msg_Max = Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
...
Num_Msg_Max = Redis:hget(Aldmon.."Aldmon:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
Redis:incr(Aldmon.."Aldmon:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Aldmon.."Aldmon:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Aldmon.."Aldmon:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Aldmon.."Aldmon:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
if Redis:get(Aldmon.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Aldmon.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* • تم الغاء الاذاعه بالتثبيت*","md",true)  
end 
local list = Redis:smembers(Aldmon.."ChekBotAdd") 
...
if Redis:get(Aldmon.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Aldmon.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* • تم الغاء الاذاعه بالتوجيه للخاص*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Aldmon.."Num:User:Pv") 
...
if Redis:get(Aldmon.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Aldmon.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Aldmon.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Aldmon.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Aldmon.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Aldmon.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Aldmon.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(Aldmon.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Aldmon.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(Aldmon.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(Aldmon.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Aldmon.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(Aldmon.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(Aldmon.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(Aldmon.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(Aldmon.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Aldmon.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(Aldmon.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Aldmon.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Aldmon.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Aldmon.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(Aldmon.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(Aldmon.."List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Aldmon.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Aldmon.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Aldmon.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Aldmon.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"* • تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= Aldmon then
local test = Redis:get(Aldmon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Aldmon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Aldmon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Aldmon.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(Aldmon.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(Aldmon.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(Aldmon.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(Aldmon.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(Aldmon.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(Aldmon.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(Aldmon.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(Aldmon.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(Aldmon.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(Aldmon.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(Aldmon.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Aldmon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Aldmon.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Aldmon.."List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Aldmon.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Aldmon..v..text)
end
Redis:del(Aldmon.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Aldmon.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"* • تم حذف الرد في قائمه الردود العامه *","md",true)  
end
end
if text then
if not Redis:sismember(Aldmon..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(Aldmon.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Aldmon.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Aldmon.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Aldmon.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Aldmon.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(Aldmon.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(Aldmon.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(Aldmon.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(Aldmon.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(Aldmon.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(Aldmon.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(Aldmon.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Aldmon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Aldmon..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(Aldmon.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(Aldmon.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Aldmon.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Aldmon.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Aldmon.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Aldmon.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(Aldmon.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(Aldmon.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(Aldmon.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(Aldmon.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Aldmon.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(Aldmon.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(Aldmon.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Aldmon..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(Aldmon..'GetTexting:DevAldmon'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر • ' then 
Redis:del(Aldmon..'GetTexting:DevAldmon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'* • تم الغاء حفظ كليشة المطور*')
end
Redis:set(Aldmon..'Texting:DevAldmon',text)
Redis:del(Aldmon..'GetTexting:DevAldmon'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' • تم حفظ كليشة المطور')
end
if Redis:get(Aldmon.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n • تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(Aldmon.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Aldmon.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Aldmon.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' • تم تعين الايدي عام',"md",true)  
end
if Redis:get(Aldmon.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n • تم الغاء امر تعين الايدي","md",true)  
Redis:del(Aldmon.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Aldmon.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Aldmon.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' • تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Aldmon.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر • ' then   
Redis:del(Aldmon.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n • تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Aldmon.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Aldmon.."Name:Bot",text) 
...
local NumberGames = Redis:get(Aldmon.."Aldmon:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Aldmon.."Aldmon:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Aldmon.."Aldmon:Set:Id:Groups") or Redis:get(Aldmon.."Aldmon:Set:Id:Group"..msg_chat_id)
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Aldmon.."Aldmon:Status:BanId"..msg_chat_id,true) 
...
Redis:del(Aldmon.."Aldmon:Status:BanId"..msg_chat_id) 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج الديمون' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج فليسوف' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Redis:sismember(Aldmon.."Aldmon:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," • تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Aldmon.."Aldmon:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Aldmon.."Aldmon:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," • تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," • تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج الديمون' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج فليسوف' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Redis:sismember(Aldmon.."Aldmon:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Aldmon.."Aldmon:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج الديمون' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId) == ' المبرمج فليسوف' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* • عذرا لا تستطيع حظر عام『 "..Controller(msg_chat_id,UserId).." 』*","md",true)  
end
if Redis:sismember(Aldmon.."Aldmon:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," • تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:BanAll:Groups",UserId) 
...
if Redis:sismember(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," • تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," • تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:get(Aldmon.."Aldmon:Status:BanId"..msg.chat_id)  then
...
Redis:del(Aldmon.."Aldmon:BanAll:Groups") 
...
Redis:del(Aldmon.."Aldmon:BanGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Aldmon.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Aldmon.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Aldmon.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Aldmon.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Aldmon.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Aldmon.."List:Manager"..msg_chat_id)
end
...
text = " • قائمه الردود \n⩹••••••⊶❲∆ 𝐀𝐋𝐃𝐄𝐌𝐎𝐍 ∆❳⊷••••••⩺\n"
for k,v in pairs(list) do
if Redis:get(Aldmon.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Aldmon.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Aldmon.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Aldmon.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Aldmon.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Aldmon.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Aldmon.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف • "
elseif Redis:get(Aldmon.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Aldmon.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Aldmon.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"* • ارسل الان الكلمه لحذفها من ردود *","md",true)  
end
if text and not Redis:sismember(Aldmon.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(Aldmon.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(Aldmon.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Aldmon.."Add:Rd:Sudo:Gif"..v)   
Redis:del(Aldmon.."Add:Rd:Sudo:vico"..v)   
Redis:del(Aldmon.."Add:Rd:Sudo:stekr"..v)     
Redis:del(Aldmon.."Add:Rd:Sudo:Text"..v)   
Redis:del(Aldmon.."Add:Rd:Sudo:Photoc"..v)
Redis:del(Aldmon.."Add:Rd:Sudo:Photo"..v)
Redis:del(Aldmon.."Add:Rd:Sudo:Video"..v)
Redis:del(Aldmon.."Add:Rd:Sudo:File"..v)
Redis:del(Aldmon.."Add:Rd:Sudo:Audio"..v)
Redis:del(Aldmon.."Add:Rd:Sudo:video_note"..v)
Redis:del(Aldmon.."List:Rd:Sudo")
end
...
for k,v in pairs(list) do
if Redis:get(Aldmon.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Aldmon.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Aldmon.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Aldmon.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Aldmon.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Aldmon.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Aldmon.."Add:Rd:Sudo:File"..v) then
db = "ملف • "
elseif Redis:get(Aldmon.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Aldmon.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(Aldmon.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Aldmon.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(Aldmon.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Aldmon.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Aldmon.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Aldmon.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
keyboard.inline_keyboard = {
{
{text = ban.first_name, url = 't.me/SOURCE_F_L_D_N'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '∆ 𝚂??𝚄𝚁𝙲𝙴 𝙳𝙰𝙴𝙼𝙾𝙽 ∆', url = 't.me/SOURCE_F_L_D_N'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
data = {
{
{text = '∆ 𝚂𝙾𝚄𝚁𝙲?? 𝙳𝙰𝙴𝙼𝙾𝙽 ∆', url = 't.me/SOURCE_F_L_D_N'}, 
},
}
}
...
local NamesBot = (Redis:get(Aldmon.."Aldmon:Name:Bot") or "الديمون")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/SOURCE_F_L_D_N'}, 
},
{
...
if text == (Redis:get(Aldmon.."Aldmon:Name:Bot") or "الديمون") then
local photo = LuaTele.getUserProfilePhotos(Aldmon)
local UserInfo = LuaTele.getUser(Aldmon)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
if not msg.ControllerBot then
if Redis:get(Aldmon.."Aldmon:TwaslBot") and not Redis:sismember(Aldmon.."Aldmon:BaN:In:Tuasl",msg.sender.user_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Aldmon.."Aldmon:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:srem(Aldmon.."Aldmon:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Aldmon.."Aldmon:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Aldmon.."Aldmon:BanGroup:Group"..ChatId) 
